...
export default function InterviewCard() {
  ...
  if (loading) {
    return (
      <div className="p-4 flex items-center justify-center min-h-37.5">
  ...
  return (
    <div className="p-4 sm:p-6 border border-slate-200 bg-gray-50 self-start w-full transition-all">
