        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-[2fr_1fr]">
            ...
            <aside className="h-fit rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:sticky lg:top-6">
              <div className="mb-6 grid grid-cols-2 gap-4 rounded-lg bg-slate-50 p-4 lg:grid-cols-1">
                <div className="space-y-1">
                  <p className="text-xs text-slate-500 md:text-sm">Posted</p>
                ...
                <div className="space-y-1">
                  <p className="text-xs text-slate-500 md:text-sm">Salary</p>
                  <p className="text-sm font-semibold text-slate-900">
                    {jobData.salary}
                  </p>
                </div>
                <div className="space-y-1">
                  <p className="text-xs text-slate-500 md:text-sm">Applications</p>
